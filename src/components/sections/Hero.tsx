...
export function Hero() {
  ...
  return (
    <section id="hero" className="scroll-mt-28 relative z-10 flex items-center justify-center py-20 md:py-32 px-6 bg-navy-black overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
        ...
        >
          <div>
            ...
            <p className="text-lg text-gray-400 font-inter mt-4 max-w-lg">
              {t('subBio')}
            </p>
          </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex flex-col items-center md:items-end space-y-8"
        >
          ...
          <a
            href="/assets/CV_Phuc_Anh_DANG.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 px-8 py-3 rounded-full border border-white/20 hover:bg-white/10 text-white font-medium transition-all duration-300 hover:scale-105 backdrop-blur-sm"
          >
            <Sparkles size={18} className="text-electric-blue group-hover:text-deep-purple transition-colors" />
